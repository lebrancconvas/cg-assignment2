...
//Vertex Shader
static const char* vShader = "/Users/poomyimyuean/Desktop/Poomkun/Hub/Code/ProjectCS/Computer-Graphic/assignment2/assignment2/Shaders/shader.vert";

//Fragment Shader
static const char* fShader = "/Users/poomyimyuean/Desktop/Poomkun/Hub/Code/ProjectCS/Computer-Graphic/assignment2/assignment2/Shaders/shader.frag";
...
void Update(long elapsedTime)
{
    ...
    {
        //s += v * dt
        triOffset3 += (triIncrement * elapsedTime / 1000.0);
    }
    else
    {
        triOffset3 -= (triIncrement * elapsedTime / 1000.0);
...
//        meshList[0]->RenderMesh();
        ...
        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(-0.25f, -triOffset2-0.48f, -1.5f));
        model = glm::scale(model, glm::vec3(0.09f, 0.09f, 1.0f));
        color = glm::vec4(255.0, 255.0, 255.0, 1);
        for (int i = 1; i <= 4; i++) {
            if (i != 1) {
        ...
        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(-0.15f, -triOffset2-0.48f, -1.5f));
        model = glm::scale(model, glm::vec3(0.09f, 0.09f, 1.0f));
        color = glm::vec4(255.0, 255.0, 255.0, 1);
        for (int i = 1; i <= 4; i++) {
            if (i != 1) {
        ...
        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(-0.05f, -triOffset2-0.48f, -1.5f));
        model = glm::scale(model, glm::vec3(0.09f, 0.09f, 1.0f));
        color = glm::vec4(255.0, 255.0, 255.0, 1);
        for (int i = 1; i <= 4; i++) {
            if (i != 1) {
        ...
        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(0.35f, -triOffset2-0.48f, -1.5f));
        model = glm::scale(model, glm::vec3(0.09f, 0.09f, 1.0f));
        color = glm::vec4(255.0, 255.0, 255.0, 1);
        for (int i = 1; i <= 4; i++) {
            if (i != 1) {
        ...
        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(0.45f, -triOffset2-0.48f, -1.5f));
        model = glm::scale(model, glm::vec3(0.09f, 0.09f, 1.0f));
        color = glm::vec4(255.0, 255.0, 255.0, 1);
        for (int i = 1; i <= 4; i++) {
            if (i != 1) {
